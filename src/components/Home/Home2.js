        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              &nbsp; like
              <i>
                <b className="purple"> Numpy, Pandas, Seaborn and Sklearn</b>
              </i>
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/nitin-pandita"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/nitintwts"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/nitin-pandita-148070213/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
